...
/***/ function(module, exports, __webpack_require__) {
	...
	//= require ./init
	//
	var Selectize = __webpack_require__(3);
	var Backbone = __webpack_require__(6);
	var tfp = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  views: (_views = {
	    checklist: __webpack_require__(9),
	    module: __webpack_require__(126),
	    widget: __webpack_require__(127),
	    widget_manager: __webpack_require__(128),
	    flash: __webpack_require__(129),
	    commitments_form: __webpack_require__(11),
	    people_picker: __webpack_require__(12),
	    toggler: __webpack_require__(10)
	  }, _defineProperty(_views, 'flash', __webpack_require__(129)), _defineProperty(_views, 'embed', __webpack_require__(130)), _views),
	  widgets: {},
	  init: function init() {
	    var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var peoplePicker = __webpack_require__(12);
	    ...
	    this.$el.selectize({
	      ...
	      render: {
	        option: function option(item, escape) {
	          return '<div>' + '<span class="title">' + escape(item.name) + '</span>' + '<span class="description"> - ' + escape(item.school_tfpid) + '</span>';
	          '</div>';
	        }
	      }
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pikaday = __webpack_require__(14);
...
/***/ function(module, exports) {
	...
	module.exports = Backbone.View.extend({
	  ...
	  activateWidget: function activateWidget(args) {
